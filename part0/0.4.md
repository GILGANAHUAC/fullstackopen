...
sequenceDiagram
    ...
    Note over browser: The user submits the form with a new note
    ...
    Note over browser: The browser reloads the notes page following the redirection
    ...
    activate server
    server-->>browser: [{ "content": "hola mundo formulario", "date": "2026-08-23" }, ... ]
    deactivate server
